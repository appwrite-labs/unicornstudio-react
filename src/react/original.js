export function initUnicornStudio() {
  ...
  const I = typeof globalThis !== "undefined" ? globalThis : (typeof window !== "undefined" ? window : {});
  if (!I.UnicornStudio) {
    I.UnicornStudio = {};
  }
  ...
  var ns = (I, O, g) =>
    O in I
      ? as(I, O, { enumerable: !0, configurable: !0, writable: !0, value: g })
      : (I[O] = g);
  ...
  class _t {
    constructor(
      ...
      ((this._canDraw = !1),
        ...
        !r &&
          s &&
          imagineDocument.getElementById(s) &&
          (r = imagineDocument.getElementById(s).innerHTML),
        !a &&
          i &&
          imagineDocument.getElementById(i) &&
          (a = imagineDocument.getElementById(i).innerHTML),
        this._initMesh(),
        (o = parseInt(o)),
        (l = parseInt(l)),
    ...
    createTexture(e = {}) {
      const t = new he(this.renderer, Object.assign(e, this._texturesOptions));
...
`,
    ...
    _createFrameBuffer() {
      ((this._frameBuffer = this.gl.createFramebuffer()),
        ...
        this.textures.length
          ...
          : new he(this.renderer, this._texturesOptions).addParent(this),
    ...
    const e = (t) => {
      ...
      (n.forEach((i) => {
        ...
        (!pe || t - pe > 64) &&
          ...
          (pe = t),
          (oe > 1e3 || (oe < 0 && !Ie && !j)) && De()),
        s ? (qt(), (le = requestAnimationFrame(e))) : cancelAnimationFrame(le));
    };
    ...
    updateEffect(e, { top: t, height: s, isFixed: i }) {
      ...
      if ((i && (t -= j), this.mode === "scrollIntoView")) {
        ...
        return (
          ...
          this.lastTick !== void 0 &&
          ((r = ve(r, this.lastTick, this.momentum * 2)), Math.abs(r) < ge)
            ? !1
        ...
        for (let i in e.props)
          ((t = e.props[i]) == null ? void 0 : t.type) === "Vec2"
            ...
            : ((s = e.props[i]) == null ? void 0 : s.type) === "Vec3"
              ...
              : typeof e.props[i] == "object" && (e.props[i] = se(e.props[i]));
      }),
      n
    );
  }
  ...
  let Le = class extends qe {
    ...
    getAbsolutePosition() {
      ...
      return ((h = +h.toFixed(1)), (o = +o.toFixed(1)), { left: h, top: o });
    }
  ...
  class Gt extends Le {
    ...
    render() {
      ...
      let l =
        ...
        u =
          ((w = this.local.stateEffectProps) == null ? void 0 : w.rotation) ??
          this.rotation,
        f = i - o.x * a,
        p = r - o.y * h;
      if (
        ...
        t.fillStyle = ze(t, this.box(), this.fill, c, this.gradientType);
      }
      (t.fill(),
      ...
      for (let t in this)
        this[t] &&
          ...
          (this[t].type === "Vec2"
            ...
            : this[t].type === "Vec3" &&
              (this[t] = new P(this[t]._x, this[t]._y, this[t]._z)));
      return this;
    }
    getParent() {
      return this.state()
  ...
  class Yt extends Le {
    ...
    render() {
      ...
      const a = ue(this.anchorPoint),
        h =
          ((Q = (B = this.local) == null ? void 0 : B.stateEffectProps) == null
            ? void 0
      ...
      const C = (y, b, R, _, z, q, ae) => {
          let W = b
              ...
              .reduce(
                (L, te, rs) =>
                  L + y.measureText(te).width + (rs < b.length - 1 ? z : 0),
                0
              ),
            N;
          if (
            (q === "center" ? (N = R + (ae - W) / 2 - ae / 2) : (N = R),
            q === "right")
          )
            ...
            for (let L = 0; L < b.length; L++)
              (y.fillText(b[L], N, _), (N += y.measureText(b[L]).width + z));
        },
        F = (y, b) => {
          let R = c + p * b + p / 2 + f / 3;
          this.isSafari
...
`
            ...
            if (b !== "")
              ((x[y] = b.trim()),
                _ !== R.length - 1
                  ? (x.splice(y + 1, 0, R.slice(_).join("")), U++)
                  : z !==
                      `
` && x.push(z));
            else {
              ...
              for (; W.length > 0; ) {
                ...
                for (
                  let te = 0;
                  te < W.length &&
                  (t.measureText(L + W[te]).width <= r || te == 0);
                  te++
                )
                  L += W[te];
                ((W = W.slice(L.length)),
                  (x[N] = L.trim()),
                  W.length > 0 && (x.splice(N + 1, 0, W), N++, U++));
              }
              R.slice(_ + 1).length > 0 && (x[N] += R.slice(_ + 1).join(""));
            }
            break;
          } else b = q;
  ...
  class Qt {
          ...
          ((i[u] = e.data.uniforms[u]),
            ((d = f.value) == null ? void 0 : d.type) === "Vec3"
              ...
              : ((c = f.value) == null ? void 0 : c.type) === "Vec2"
                ...
                : typeof f.value == "object" && (i[u].value = se(f.value)));
        }
      return {
        fragmentShader: r,
        vertexShader: a,
    ...
    handleElementPlane(e, t) {
      ...
      if (
        ...
        a &&
          ...
          o && e.mask && Y(s, "uPreviousLayerTexture", o.getTexture()));
      }
    }
    ...
    getMousePosWithMomentum(e, t, s) {
      ...
      return (
        (p < ge && m < ge) ||
          (h
            ? ((i = ve(i, u, l * 2)), (e.local.lastMousePos.x = i / t))
            : (e.local.lastMousePos.x = 0.5),
          o
            ? ((r = ve(r, f, l * 2)), (e.local.lastMousePos.y = 1 - r / s))
    ...
    setEffectPlaneUniforms(e, t) {
      ...
      if (
        ...
        Te() &&
          (o = (h = this.interactivity) == null ? void 0 : h.mouse) != null &&
          o.disableMobile)
      )
        return !1;
  ...
  function Jt() {
    (ie(window, "scroll", Je),
      ...
      (de = Lt($t, 16)),
      Te() ? ie(window, "orientationchange", de) : ie(window, "resize", de),
      ie(document, fe, Qe),
      (Fe = !0));
  }
  function Oe() {
    (re(window, "mousemove", Me),
      ...
      de && (re(window, "resize", de), re(window, "orientationchange", de)),
      re(document, fe, Qe),
      (Fe = !1));
  }
  function Kt(n, e, t) {
  ...
  function ts(n, e, t, s, i) {
    ...
    if (t) {
      r = t;
      const a = imagineDocument.getElementById(t);
      if (a)
        try {
      ...
      dataPromise
        .then((r) => {
          ...
          const a = r.options || {},
            h = Zt(n.element)
              ? n.element
              : imagineDocument.getElementById(n.elementId);
          if (!h) {
            i(
              new Error(
          ...
          ((f || a[me("aW5jbHVkZUxvZ28=")]) && Ot(o, h),
            f && console.log(me("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")),
            S.push(u),
            (u.layers = c),
            u.preloadTextures(),
  ...
  function is() {
    return ss()
      ? new Promise((n, e) => {
          const t = [
              ...imagineDocument.querySelectorAll(
  ...
  I.UnicornStudio.addScene = et;
  I.UnicornStudio.destroy = es;
  I.UnicornStudio.init = is;
  I.UnicornStudio.scenes = S;
  I.UnicornStudio.unbindEvents = Oe;
  Object.defineProperty(I.UnicornStudio, Symbol.toStringTag, { value: "Module" });
  
  return I.UnicornStudio;
}
